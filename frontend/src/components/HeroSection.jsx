...
function HeroSection() {
  return (
    <div className='text-center mt-8 p-4 space-y-4'>
      <h1 className='inline px-4 py-1 text-md font-semibold bg-red-200 rounded-full text-[#d53030]'>Hire the Real Talent</h1>
      ...
      <div className='w-full md:w-1/2 mx-auto border border-red-900 rounded-full bg-gray-100 flex'>
        <input type="text" className=' caret-red-900 w-full px-4 outline-0' placeholder='Find and Search for Job!!'/>
        <Button className="bg-red-900 rounded-r-full w-30 hover:bg-[#510a19]">
